...
@Component({
	selector: 'app-aplicar-cb2-page',
	templateUrl: './aplicar-cb2-page.component.html',
	styleUrls: ['./aplicar-cb2-page.component.scss']
})
export class AplicarCb2PageComponent {
	...
	constructor(
		...
		private _dialogRef: MatDialogRef<AplicarCb2PageComponent>,
